...
class EvenParityCheckerGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Even Parity Checker Simulation")
    ...
    def update_images(self):
        for name, label in self.labels.items():
            ...
            if name.startswith("switch"):
                ...
                output = not (A ^ B ^ C)  # Even parity checker condition
    ...
    def paintEvent(self, event):
        ...
        painter.drawLine(109,356,217,356)
        painter.drawLine(508,150,389,150)
        painter.drawLine(389,150,389,196)
